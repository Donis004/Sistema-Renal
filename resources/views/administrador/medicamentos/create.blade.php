...
<head>
  <meta charset="UTF-8" />
  <title>Crear Medicamento - Sistema Renal</title>
      ...
      <div class="col-md-10">
        ...
        <div class="header-section">
          <div class="row align-items-center">
            <div class="col-md-8">
              <h2 class="mb-1"><i class="bi bi-plus-circle me-2"></i>Crear Nuevo Medicamento</h2>
              <p class="mb-0 opacity-75">Agrega un nuevo medicamento al catálogo</p>
            </div>
        ...
        <div class="card-custom">
          <form method="POST" action="{{ route('administrador.medicamentos.store') }}">
            @csrf
              ...
              <div class="col-md-12 mt-4">
                <div class="d-flex gap-2">
                  <button type="submit" class="btn btn-success-custom">
                    <i class="bi bi-check-circle me-2"></i>Crear Medicamento
                  </button>
