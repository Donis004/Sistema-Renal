...
<head>
  <meta charset="UTF-8" />
  <title>Editar Usuario - Sistema Renal</title>
...
<h5 class="fw-bold mb-4"><i class="bi bi-heart-pulse text-danger"></i> RenalMe</h5>
      ...
      <div class="col-md-10">
        ...
        <div class="header-section">
          <div class="row align-items-center">
            <div class="col-md-8">
              ...
              <p class="mb-0 opacity-75">Modifica los datos del usuario</p>
            </div>
            <div class="col-md-4 text-end">
              <a href="{{ route('administrador.usuarios.index') }}" class="btn btn-light">
        ...
        <div class="card-custom">
          <form method="POST" action="{{ route('administrador.usuarios.update', $usuario->id_usuario) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
              ...
              <div class="col-md-12">
                ...
                <select class="form-select form-control-custom @error('rol') is-invalid @enderror" 
                  ...
                  <option value="NUTRICIONISTA" {{ old('rol', $usuario->rol) == 'NUTRICIONISTA' ? 'selected' : '' }}>Nutricionista</option>
              ...
              <div class="col-md-12 mt-4">
                <div class="d-flex gap-2">
                  ...
                  <a href="{{ route('administrador.usuarios.index') }}" class="btn btn-outline-custom">
                    Cancelar
                  </a>
                </div>
              </div>
