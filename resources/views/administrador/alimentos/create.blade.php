...
<head>
  <meta charset="UTF-8" />
  <title>Crear Alimento - Sistema Renal</title>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-10">
        <div class="header-section">
          <div class="row align-items-center">
            <div class="col-md-8">
              ...
              <p class="mb-0 opacity-75">Agrega un nuevo alimento al catálogo del sistema</p>
            </div>
        ...
        <div class="card-custom">
          <form method="POST" action="{{ route('administrador.alimentos.store') }}">
            @csrf
            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" 
                       placeholder="Ej: Manzana Roja" required maxlength="150">
                @error('nombre')
              ...
              <div class="col-md-6">
                ...
                <div class="form-check form-switch mt-2">
                  <input class="form-check-input" type="checkbox" id="seguro_renal" name="seguro_renal" value="1">
              ...
              <div class="col-md-12 mt-4">
                <div class="d-flex gap-3 justify-content-end">
                  ...
                  <button type="submit" class="btn btn-primary-custom">
                    <i class="bi bi-check-circle me-2"></i>Guardar Alimento
                  </button>
                </div>
              </div>
            </div>
