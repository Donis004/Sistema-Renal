...
<head>
  <meta charset="UTF-8" />
  <title>Crear Recomendación - Sistema Renal</title>
      ...
      <div class="col-md-10">
        ...
        <div class="header-section">
          <div class="row align-items-center">
            <div class="col-md-8">
              <h2 class="mb-1"><i class="bi bi-plus-circle me-2"></i>Crear Recomendación</h2>
              <p class="mb-0 opacity-75">Agrega una nueva recomendación de profesional a paciente</p>
            </div>
        ...
        <div class="card-custom">
          <form method="POST" action="{{ route('administrador.recomendaciones.store') }}">
            @csrf
              ...
              <div class="col-md-6">
                ...
                <select class="form-select form-select-custom @error('id_profesional') is-invalid @enderror" 
                  ...
                  @foreach($profesionales as $profesional)
                    <option value="{{ $profesional->id_usuario }}" {{ old('id_profesional') == $profesional->id_usuario ? 'selected' : '' }}>
            ...
            <div class="row g-3 mb-4">
              <div class="col-md-12">
                ...
                <textarea class="form-control form-control-custom @error('mensaje') is-invalid @enderror" 
                          ...
                          placeholder="Escribe la recomendación aquí..." required>{{ old('mensaje') }}</textarea>
                @error('mensaje')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-12 mt-4">
              <div class="d-flex gap-2">
                <button type="submit" class="btn btn-success-custom">
                  <i class="bi bi-check-circle me-2"></i>Guardar Recomendación
                </button>
